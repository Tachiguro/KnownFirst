...
public sealed class WindowsPackageVersionMappingTests
{
    ...
    private const string ExpectedBuildNumber = "15";
    ...
    private const string ExpectedMsixPackageVersion = "1.0.15.0";
    ...
    public void MsixVariant_MapsPackageVersionToStoreValidFourPartVersion()
    {
        ...
        Assert.AreEqual("1.0.15", properties["ApplicationDisplayVersion"],
