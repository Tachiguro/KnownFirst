...
- Branch: docs/task-based-documentation-routing
...
- Active work is on branch `docs/task-based-documentation-routing`.
- Universal repository instructions in [AGENTS.md](../AGENTS.md) streamlined.
- Task-based documentation router rebuilt in [docs/INDEX.md](INDEX.md).
- Delivery and validation workflow updated in [docs/AGENT_WORKFLOW.md](AGENT_WORKFLOW.md).
...
- Documentation refactoring and task-based routing package.
...
- Markdown link and structure verification.
...
1. Review and merge pull request for `docs/task-based-documentation-routing`.
2. Synchronize master to merged PR HEAD.
3. Authorized post-merge release output package: build Windows Debug/Release, Android Debug/Release (-m:1), and Beta 9 AAB from synchronized master.
...
- Review pull request for `docs/task-based-documentation-routing` and decide on manual merge.
