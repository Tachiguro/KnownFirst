...
> **Regression status (2026-07-22):** The originating Android Release crashes
> are resolved in `1.0.0-beta.8` by commits `f1f1891` and `29aff385`.
> Retain this plan for future Android regression runs. Test case 10 applies only
> to Debug or diagnostic builds because normal Release does not expose
