...
- [Decision records](docs/decisions/README.md) preserve rationale. `1.0.0-beta.12` remains the [latest confirmed externally distributed and device-tested release](docs/releases/1.0.0-beta.12.md) (Google Play Internal Testing, confirmed 2026-07-30). `1.0.0-beta.13` is merged source identity on `master` (build 13); compilation validation has occurred during repository gates, but the final merged Beta-13 Mandatory Pre-AAB Release-Readiness Gate has not been established, no release AAB/APK package has been authorized or created, and no newer external distribution has occurred — see [docs/releases/1.0.0-beta.13.md](docs/releases/1.0.0-beta.13.md). The [Beta 8 release notes](docs/releases/1.0.0-beta.8.md) and the [Beta 8 handoff](docs/handoffs/2026-07-22-beta-8-release.md) are retained as historical evidence only.
