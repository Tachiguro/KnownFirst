...
**Active local candidate — Beta 13:** a `1.0.0-beta.13` / build `13` release-candidate implementation exists on branch `release/1.0.0-beta.13-candidate-v1` (base `master` `810a7bcd0979c2f482135c07b56f834204b53118`), **local and uncommitted**. It is not yet binding `master` identity, has not been reviewed, merged, built, packaged, or distributed. Focused genuine RED **7 failed / 36 passed / 0 skipped / 43 total** → identical GREEN **43 passed / 0 failed / 0 skipped / 43 total**; bounded affected/regression `TEST_ONLY` **138 passed / 0 failed / 0 skipped / 138 total** with unchanged pre/post implementation-file SHA-256 hashes and passing `git diff --check`. Candidate evidence record: [docs/releases/1.0.0-beta.13.md](releases/1.0.0-beta.13.md). The last confirmed external distribution remains `1.0.0-beta.12` / build 12 (2026-07-30); that evidence predates and does not validate current Schema-10 populated-target merge or Active-workflow portability.
...
| Local release-candidate version (uncommitted, `release/1.0.0-beta.13-candidate-v1`) | `1.0.0-beta.13` (build 13) — not yet binding `master` identity; see "Active local candidate — Beta 13" above and [docs/releases/1.0.0-beta.13.md](releases/1.0.0-beta.13.md) |
