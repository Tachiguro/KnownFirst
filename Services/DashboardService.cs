    ...
    public Task<DashboardStatistics> GetStatisticsAsync() =>
        database.ExecuteSnapshotAsync(connection =>
        {
            ...
            var preparedAndLearningWordCount = capability switch
            {
                ...
                LearningSchema8CapabilityResult or LearningSchema9CapabilityResult or LearningSchema10CapabilityResult or LearningSchema11CapabilityResult => connection.ExecuteScalar<int>(
                    """
