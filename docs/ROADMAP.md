...
| 15 | Portable merge integrity hardening | Current | Portable database export/import integrity is hardened in bounded packages before GUI automation begins. **KF-BACKUP-003 Package D, KF-BACKUP-004, KF-BACKUP-005A, KF-BACKUP-005B, KF-BACKUP-005C, the `LegacyReviewSummaries` correction, and the `Learning.Cards` correction are committed and merged** via PRs #76, #77, #79, #81, #83, #85, and #87. PR #87 is binding `master` behavior at merge commit `e97c83ac0cf7decf2915162e0e3a4abf24ee30d8` (feature head `2cab8042887bed1004e7c26573a52fd59cc3b380`); `POST_MERGE_SYNC_ONLY` completed successfully. Final affected/regression `TEST_ONLY`: **119 passed / 0 failed / 0 skipped**; independent review: **0 BLOCKER / 0 MAJOR / 0 MINOR / 0 NIT**. Schema 10 and archive V2 remain unchanged. The legacy v1 planner's analogous synthesized label is the sole remaining Priority-15 residual and next package; GUI automation remains after Priority 15. Evidence is bounded automated unit/integration/contract evidence only; it is not ALL_AUTOMATED, ValidateAll, GitHub CI, platform/runtime, Release-build, rendered-GUI, device/emulator, APK/AAB, signing, publishing, or distribution evidence. |
...
**Portable merge integrity hardening (priority 15) is the current milestone, and precedes automated GUI validation.** KF-BACKUP-003 Package D is merged via PR #76, KF-BACKUP-004 via PR #77, KF-BACKUP-005A via PR #79, KF-BACKUP-005B via PR #81, KF-BACKUP-005C via PR #83, the `LegacyReviewSummaries` canonical ordering correction via PR #85, and **the `Learning.Cards` canonical ordering correction via PR #87** (feature head `2cab8042887bed1004e7c26573a52fd59cc3b380`, merge commit `e97c83ac0cf7decf2915162e0e3a4abf24ee30d8`); `POST_MERGE_SYNC_ONLY` completed successfully for all. PR #87 final affected/regression `TEST_ONLY` is **119/0/0**, and independent review found **0 BLOCKER / 0 MAJOR / 0 MINOR / 0 NIT**. The legacy v1 planner analogous synthesized label is the sole remaining Priority-15 residual and next package. See [CURRENT_WORK.md](CURRENT_WORK.md) for lifecycle state.
...
15. **`Learning.Cards`/Sense-`StableId` canonical ordering correction:** Merged and binding `master` behavior via PR #87 (feature head `2cab8042887bed1004e7c26573a52fd59cc3b380`, merge commit `e97c83ac0cf7decf2915162e0e3a4abf24ee30d8`); `POST_MERGE_SYNC_ONLY` completed successfully. Final affected/regression `TEST_ONLY`: **119 passed / 0 failed / 0 skipped**; independent review: **0 BLOCKER / 0 MAJOR / 0 MINOR / 0 NIT**. It corrects archive-local `c-*` semantic-binding instability without changing Schema 10, archive V2, DTOs, migrations/validators, V1 compatibility, merge/scheduler semantics, UI, transport, synchronization, public status/error codes, or persistence contracts. Priority 15 remains Current; the legacy v1 planner analogous synthesized-label issue is its sole remaining residual and next package. Priority 16 remains Planned.
