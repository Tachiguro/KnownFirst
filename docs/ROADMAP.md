...
| 16 | Automated GUI validation | Current | P16-A — Android rendered-navigation foundation, its duplicate-configuration correction, and its review correction commit `9719f3089ea758a6a65b3c5378834c1367227116` (`fix: harden Android GUI automation foundation`) are committed and pushed to PR #91. PR body reconciliation, renewed independent PR review, manual merge if approved, and future rendered Android runtime validation remain pending; no matrix row is automated. The intended direction remains Android-first deterministic automation with Appium/UiAutomator2, followed later by standard Windows launcher integration. |
