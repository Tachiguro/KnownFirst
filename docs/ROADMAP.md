...
| 16 | Automated GUI Validation | Planned (P16-A & P16-B Committed) | P16-A Android automation foundation merged (PR #91). P16-B Android S36 source mapping merged (PR #164; contract tests only; runtime matrix evidence remains separate). P16-C (Windows launcher integration) pending. |
